...
int middle_number(int num1, int num2, int num3)//äôåð÷öéä î÷áìú ùìåùä îñôøéí åîçæéøä àú òøê äîñôø äàîöòé
{
...
int	rain_days(int numDays)//äôåð÷öéä î÷áìú àú ëîåú äâùí ùéøã áîùê îñôø éîéí åîçæéøä àú îñôøå ùì äéåí äøàùåï ùáå äçì äøöó äî÷ñéîìé ùì éîé âùí
{
	int counter = 0;
	int maxDayCount = 0;
	int maxCount = 0;
...
int multiplie(int x, int y)//äôåð÷öéä î÷áìú òøê ùì 2 îñôøéí åîáöòú ëôì áéðéäí
{
	int i;
	int result = 0;
...
double function(double n, double x)//äôåð÷öéä î÷áìú îñôø èáòé åîñôø îîùé åîçùáú ñëåí. äôåð÷öéä øöä áñãø âåãì äîñôø äèáòé 
{
...
int Sum_Proper_Divisors(int n)//äôåð÷öéä î÷áìú îñôø åáåã÷ú áèååç äîñôø äîú÷áì àú äîñôøéí äéãéãéí ä÷ééîéí
{
	int sum = 1, i;
	if (n == 1)
		return 1;
